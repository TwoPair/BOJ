...
// DOC: https://github.com/ouuan/CPTH/blob/master/docs/SegmentTree.md
...
{
    /**
     * @tparam valueType data type to contain
     * @tparam modType data type to modify those contained valueType with customized methods
     */
